...
class AppLanguageTranslation {
  ...
  static const String tapBackAgainToExitTransKey = 'tap back again to exit';
  ...
  static const String availableStockTransKey = 'available / product stock';
  ...
  static const String optionTransKey = 'option';
  ...
  static const String selectOptionTransKey = 'select a option';
  ...
  static const String addLastNameTransKey = 'your last name';
  ...
  static const String selectEndTimeTransKey = 'select end time';
  static const String cardNameTransKey = 'card name';
  ...
  static const String addNewTicketTransKey = 'add new ticket';
  static const String addSpecificationTransKey = 'add specification';
  static const String deleteTransKey = 'delete';
  static const String categoryesTransKey = 'categories';
  ...
  static const String orderProcessingTransKey = 'order processing';
  static const String orderConfirmedTransKey = 'order confirmed';
  static const String editBrandTransKey = 'edit brand';
  static const String addBrandTransKey = 'add brand';
  static const String setupStoreTransKey = 'setup store';
  static const String deleteOptionTransKey = 'delete option';
  static const String addOptionTransKey = 'add an option';
  static const String noTicketFoundTransKey = 'sorry! no ticket found ';
  static const String departmentTransKey = 'department';
  static const String youHaveNoTicketTransKey =
      'you have no support ticket. create a support ticket based on your issue';
  static const String typesTransKey = 'types';
  static const String deliveredTransKey = 'delivered';
  static const String createNewTicketTransKey = 'create new ticket';
  static const String browesTypesTransKey =
      'browse and chose the files you want to upload from your mobile or computer';

  static const String propertiesTransKey = 'priorities';
  static const String writeYourSubjectTransKey = 'write your subject';
  static const String addFirstNameTransKey = 'your first name';
  static const String addattributeTransKey = 'add an attribute';
  static const String yourOrderProcessingTransKey =
      'your order is processing to deliver you on time.';
  static const String colorHexCodeTransKey = 'enter color hex code';

  static const String imageAddConfirmationTransKey =
      'are you sure to set this image as brand logo?';
  static const String accountUpdatedSuccessfullyTransKey =
      'account updated successfully!';
  static const String successFullyProfileImageTransKey =
      'successfully uploaded profile image';
  static const String imageSetConfirmTransKey =
      'are you sure to set this image as profile picture?';
  static const String imageprocessingErrorTransKey =
      'error occurred while processing image';
  static const String somethingWrongTransKey =
      'something wrong. fix them first.';
  static const String canNotEmptyTransKey = 'can not be empty';
  static const String successfullyUploadBrandLogoTransKey =
      'successfully uploaded brand logo!';
  static const String productImagerequiredTransKey =
      'product image is required';
  static const String imageprocessingTransKey = 'image is processing';
  static const String updatestoreDetailsTransKey = 'update store details';
  static const String productDeliveredDetailsTransKey =
      'product deliver to you and marked as delivered by customer.';
  static const String sessionExpiredPleaseLoginTransKey =
      'session expired! please login again';
  static const String errorOccurredWhileProcessingImageTransKey =
      'error occurred while processing image';
  static const String areYouSureToSetProfileImageTransKey =
      'are you sure to set this image as profile picture?';
  static const String setStoreLocationTransKey = 'set store location';
  ...
  static final Map<String, String> fallBackEnglishTranslation = {
    ...
    colorHexCodeTransKey: 'Enter Color Hex Code',
    canNotEmptyTransKey: 'Can not be empty',
    imageSetConfirmTransKey:
        'Are you sure to set this image as profile picture?',
    successfullyUploadBrandLogoTransKey: 'Successfully uploaded brand logo!',
    somethingWrongTransKey: 'Something wrong. Fix them first.',
    imageprocessingTransKey: 'Image is processing',
    orderProcessingTransKey: 'Order Processing',
    createNewTicketTransKey: 'Create New ticket',
    orderConfirmedTransKey: 'Order Confirmed',
    addattributeTransKey: 'Add an Attribute',
    propertiesTransKey: 'Priorities',
    deleteOptionTransKey: 'Delete option',
    imageprocessingErrorTransKey: 'Error occurred while processing image',
    successFullyProfileImageTransKey: 'successfully uploaded profile image',
    accountUpdatedSuccessfullyTransKey: 'Account Updated Successfully!',
    updatestoreDetailsTransKey: 'Update Store Details',
    noTicketFoundTransKey: 'Sorry! No Ticket Found ',
    writeYourSubjectTransKey: 'write your subject',
    editBrandTransKey: 'Edit Brand',
    couponTransKey: 'Coupon',
    addBrandTransKey: 'Add brand',
    typesTransKey: 'Types',
    deliveredTransKey: 'Delivered',
    productDeliveredDetailsTransKey:
        'Product deliver to you and marked as delivered by customer.',
    browesTypesTransKey:
        'Browse and chose the files you want to upload from your mobile or computer',
    departmentTransKey: 'Department',
    addNewTicketTransKey: 'Add new ticket',
    ...
    homeTransKey: 'Home',
    youHaveNoTicketTransKey:
        'You have no support ticket. create a support ticket based on your issue',
    imageAddConfirmationTransKey:
        'Are you sure to set this image as brand logo?',
    ...
    setupStoreTransKey: 'Setup Store',
    ...
    addOptionTransKey: 'Add an option',
    ...
    selectOptionTransKey: 'select a option',
    ...
    productImagerequiredTransKey: 'Product image is required',
    ...
    selectEndTimeTransKey: 'Select end time',
    ...
    addFirstNameTransKey: 'Your First Name',
    addLastNameTransKey: 'Your last name',
    valueTransKey: 'Value',
    ...
    availableStockTransKey: 'Available / Product stock',
    ...
    sessionExpiredPleaseLoginTransKey: 'Session expired! Please login again',
    editTransKey: 'Edit',
    tapBackAgainToExitTransKey: 'Tap back again to exit',
    errorOccurredWhileProcessingImageTransKey:
        'Error occurred while processing image',
    areYouSureToSetProfileImageTransKey:
        'Are you sure to set this image as Profile Picture?',
    setStoreLocationTransKey: 'Set store location',
