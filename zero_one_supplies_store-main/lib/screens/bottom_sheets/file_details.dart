import 'package:ecomikstoreapp/controller/bottom_sheets/file_details.dart';
...
class FileDetailsBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final titleWidget =
        Text('File details', style: AppTextStyles.dialogTitleTextStyle);
    final titleRightSideWidget = TightIconButtonWidget(
        onTap: () {
          Get.back();
        },
        icon: Image.asset(AppAssetImages.cross));
                      ...
                      children: [
                        ...
                        Expanded(
                          child: CustomStretchedTextButtonWidget(
                              buttonText: 'Download file again',
                  ...
                  case DownloadTaskStatus.complete:
                    return Row(
                      children: [
                        ...
                        Expanded(
                            child: CustomStretchedTextButtonWidget(
                                buttonText: 'Open downloaded file',
                                onTap:
