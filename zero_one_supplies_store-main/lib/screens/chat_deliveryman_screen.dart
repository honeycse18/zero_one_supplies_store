import 'package:ecomikstoreapp/controller/chat-with_deliveryman_controller.dart';
...
class ChatDeliverymanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ChatWithDeliverymanScreenController>(
        init: ChatWithDeliverymanScreenController(),
        builder: (controller) => DecoratedBox(
              ...
              child: Scaffold(
                ...
                appBar: CoreWidgets.appBarWidget(
                    screenContext: context, titleWidget: const Text('Chat')),
                /* <-------- Content --------> */
                body: Container(
