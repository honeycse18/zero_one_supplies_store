...
class FileDetailsBottomSheetController extends GetxController {
  ...
  void onOpenDownloadedFileButtonTap() async {
    try {
      ...
      AppDialogs.showErrorDialog(messageText: 'Failed to open file');
    }
  }
    ...
    switch (downloadTaskStatus) {
      case DownloadTaskStatus.failed:
        AppDialogs.showErrorDialog(
            messageText: 'Failed to download file. Please try again');
        break;
      case DownloadTaskStatus.canceled:
        Helper.showSnackBar('Download cancelled!');
        break;
      case DownloadTaskStatus.paused:
      case DownloadTaskStatus.enqueued:
      case DownloadTaskStatus.undefined:
      case DownloadTaskStatus.complete:
        Helper.showSnackBar('Download completed!');
        break;
