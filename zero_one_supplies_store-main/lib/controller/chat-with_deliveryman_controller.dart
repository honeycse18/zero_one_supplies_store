...
import 'package:ecomikstoreapp/models/api_responses/chat_messages.dart';
...
import 'package:ecomikstoreapp/screens/bottom_sheets/file_details.dart';
...
class ChatWithDeliverymanScreenController extends GetxController {
  ...
  bool isMyChatMessage(ChatMessage chatMessage) {
    final myID = Helper.getVendor().id;
